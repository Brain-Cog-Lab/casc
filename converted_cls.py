...
/data/ly/casc/20230212-222130-vgg16-imagenet-avg-True-4-42
/data0/ly/casc/20230217-181932-vgg16-imagenet-avg-True-8-42
/data0/ly/casc/20230223-005156-vgg16-imagenet-avg-True-16-42c

/data2/ly/casc/20231125-170530-resnext50_32x4d-cifar100-avg-True-8-42
/data2/ly/casc/20231125-021240-resnext50_32x4d-cifar100-avg-True-16-42
/data2/ly/casc/20231125-170701-regnet_x_8gf-cifar100-avg-True-8-42
/data2/ly/casc/20231125-021151-regnet_x_8gf-cifar100-avg-True-16-42
'''

parser.add_argument('--ckpt_path', type=str,
                    default="/data2/ly/casc/20231125-170701-regnet_x_8gf-cifar100-avg-True-8-42")
...
parser.add_argument('--sleep', default=56, type=int, help='sleep time')
...
# parser.add_argument('--pseudo_convert', default=True, type=bool, help='pseudo_convert')
...
def evaluate_net(data_iter, net, device, args=None):
    net.eval()
...
def close_bias(model):
    ...
    for i, (name, child) in enumerate(children):
        if isinstance(child, (nn.Conv2d, nn.Linear)) and hasattr(child, 'bias') and child.bias is not None:
            child.bias.data *= 0
        else:
            close_bias(child)
...
if __name__ == '__main__':
    ...
    acc = evaluate_net(test_loader, model, device, args)
    print("acc: %.4f" % acc)
    args.acc_ann = acc
