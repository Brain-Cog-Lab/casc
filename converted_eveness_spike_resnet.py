...
parser.add_argument('--ckpt_path', type=str, default="/data0/ly/casc/20230205-035558-resnet34-imagenet-avg-True-8-42")
...
parser.add_argument('--sleep', default=0, type=int, help='sleep time')
parser.add_argument('--margin', default=8, type=float, help='sleep margin')
parser.add_argument('--T', default=16, type=int, help='simulation time')
